...
import { CategoryAxis, Chart, Column, Gridlines, LineGraph, Marker, NumericAxis, PieChart, PieSlice } from 'cx/charts';
						...
						<Svg style='width:200px; height:100%;'>
							...
							>
								...
								<Repeater records-bind='bars' recordName='$point'>
									<Column width={0.8} colorIndex-bind='$point.colorIndex' x-bind='$point.day' y-bind='$point.value' />
								</Repeater>
							</Chart>
						</Svg>
					</div>
				...
				<Section mod='card'>
					...
					<div class='kpi-main'>
						<Svg style='width:200px; height:100%;'>
							...
							>
								<Gridlines xAxis={false} />
								<LineGraph data-bind='bars' xField='day' yField='value' colorIndex={6} lineStyle='stroke-width: 5px' />
								<Repeater records-bind='bars' recordName='$point'>
									<Marker
										size={10}
										class='line-marker'
				...
				<Section mod='card'>
					...
					<div class='kpi-main'>
						<Svg style='width:180px; height:100%;'>
							<PieChart>
								<PieSlice value={80.1} r={90} r0={70} colorIndex={7} />
