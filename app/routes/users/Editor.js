import { Section, Button, FlexRow, LinkButton, TextField, Checkbox, Rescope, ValidationGroup } from 'cx/widgets';
...
export default (
	<cx>
		<Rescope bind='$page' controller={Controller}>
			...
			<Section mod='card' style='max-width: 300px' title-bind='user.display'>
				<ValidationGroup
					layout={{
				...
				>
					...
					<hr />
					<FlexRow spacing>
						<Button mod='primary' onClick='onSave' disabled-bind='invalid'>
							Save
						</Button>
